...
import { formatDateBr, formatDateEventCard, getEventDateRange, limitPortableTextBlocks } from "@/utils";
          ...
          >
            ...
            <div className="relative flex flex-col pt-14 justify-between min-h-52 lg:h-full z-10 text-white">
              <div className="flex flex-col gap-2">
                ...
                <div className={`${isSelect == idx ? "block" : "lg:hidden"} text-sm text-gray-200 max-h-[130px] text-overflow text-ellipsis py-4`}>
                  {shortDescription && <PortableText value={limitedContent} />}
                  </div>
              </div>
              ...
              <div className="flex items-center gap-2 justify-between lg:justify-start mt-2">
                ...
                >
                  <p className="font-semibold !text-left min-w-[106px]">{formatDateEventCard(schedule)}</p> 
