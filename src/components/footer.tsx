...
export default async function Footer() {
  ...
  return (
    <React.Fragment>
      <Section
        backgroundColor="bg-[#179389] !py-8 lg:!py-12"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-8">
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-2">
                <div className="w-2 h-2 bg-teal-400 rounded-full"></div>
                <p>{formatPhone(footer_data?.helpPhone)}</p>
              </div>
              ...
              <div className="flex items-center gap-2">
                <div>
                  ...
                  <p className="pl-4">
                    {footer_data?.address?.district},{" "}
                    {footer_data?.address?.city} - {footer_data?.address?.state}
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="h-[300px] lg:h-full relative rounded-lg overflow-hidden">
      ...
      <Section backgroundColor="!py-0 bg-[#0F2E2F]">
